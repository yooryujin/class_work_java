 ...
 * 메서드 연습
 * 메서드란?
 * 객체에 소속된 함수로, 클래스의 상태(데이터)를 활용하거나
 * 객체와 관련된 작업을 처리할 때 사용한다.
 */
public class CoffeeMachine {
    ...
    public CoffeeMachine(int machineWater, int machineCoffee) {
        water = machineWater;
        coffee = machineCoffee;
    }
